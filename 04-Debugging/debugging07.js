 ...
 * if, else if, and else statements in JavaScript. 
 * 
 ...
 * 
 * As covered in previous challenges, the assignment operator (=) in JavaScript assigns a value to a 
 * variable name. And the == and === operators check for equality (the triple === tests for strict equality, 
 * meaning both value and type are the same).
 * 
 * The code below assigns x to be 2, which evaluates as true. 
 * Almost every value on its own in JavaScript evaluates to true, except what are known as the "falsy" 
