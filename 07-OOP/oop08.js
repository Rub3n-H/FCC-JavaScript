 ...
 *
 * instanceof allows you to  compare an object to a constructor, returning true or false based on whether
 * or not that object was created with the constructor. Here's an example:
 *
 ...
 *
 * If an object is created without using a constructor, instanceof will verify that it is not an instance
 * of that constructor:
 *
 * let canary = {
 *   name: "Mildred",
