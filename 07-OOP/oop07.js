 ...
 * However, notice that all Birds that are created with the Bird constructor are automatically named 
 * Albert, are blue in color, and have two legs. 
 * 
 ...
 * 
 * They group objects together based on shared characteristics and behavior and define a blueprint 
 ...
 * 
 * Then create a new Dog saved in a variable terrier. Pass it two strings as arguments for the name and 
 * color properties.
 */
...
let terrier = new Dog("Pluto", "Yellow");