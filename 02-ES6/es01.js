 ...
 * // logs 'David'
 * 
 * As you can see in the code above, the camper variable is originally declared as James and then 
 ...
 * 
 * If you were to replace var with let in the variable declarations of the code above, the result would be an 
 * error.
 * 
 * let camper = 'James';
