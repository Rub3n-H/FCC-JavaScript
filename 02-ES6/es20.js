 ...
 * 
 * This is to be noted, that the class syntax is just a syntax, and not a full-fledged class based 
 * implementation of object oriented paradigm, unlike in languages like Java, or Python, or Ruby etc.
 * 
...
const carrot = new Vegetable('Apple');
