 ...
 * items, then the number of items to remove. 
 * 
 ...
 * 
 * Recall that the slice method takes two arguments for the indices to begin and end the slice 
 * (the end is non-inclusive), and returns those items in a new array. 
 * 
 ...
 * It should limit the provided cities array to a length of 3, and return a new array with only the first 
 * three items.
 * 
