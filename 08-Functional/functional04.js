/**
 * If you haven't already figured it out, the issue in the previous challenge was with the splice call 
 * in the tabClose() function. 
 * 
 * Unfortunately, splice changes the original array it is called on, so the second call to it used a 
 * modified array, and gave unexpected results.
 * 
 ...
 * 
 * The previous example didn't have any complicated operations but the splice method changed the 
 * original array, and resulted in a bug.
 * 
