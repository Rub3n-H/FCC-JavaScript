 ...
 * 
 * 1) Don't alter a variable or object - create new variables and objects and return them if need be 
 * from a function.
 * 
...
function remove(books, bookName) {
    let localBookList = [...books];
    if (localBookList.indexOf(bookName) >= 0) {
        localBookList.splice(localBookList.indexOf(bookName), 1);
    }
    return localBookList;
}
