 ...
 * it does not have any other arrays nested within it. 
 * 
 ...
 * // logs 7
 * 
 * All array's have a length property, which as shown above, can be very easily accessed with the 
 * syntax Array.length.
 * 
 ...
 * which we will examine very closely in our next section, but for now, all you need to know is that 
...
let yourArray = ["Anirudh", "Sharma", 28, 178, true];