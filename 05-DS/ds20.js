 ...
 * You can add, modify, and remove key-value pairs, check if keys exist, and iterate over all the keys 
 * in an object. 
 * 
 * As you continue learning JavaScript you will see even more versatile applications of objects. 
 * Additionally, the optional Advanced Data Structures lessons later in the curriculum also cover 
 * the ES6 Map and Set objects, both of which are similar to ordinary objects but provide some additional 
 * features. 
 * 
 * Now that you've learned the basics of arrays and objects, you're fully prepared to begin tackling 
