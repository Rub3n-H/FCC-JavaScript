 ...
 * Arrays can be defined with a length of any number of elements, and elements can be added or 
 * removed over time; in other words, arrays are mutable. 
 * 
 ...
 * is being called on; the push() method adds elements to the end of an array, and unshift() adds elements 
 ...
 * Modify the function by using push() and unshift() to add 'I', 2, 'three' to the beginning of the array and 
