 ...
 * at once? 
 * 
 * Well, that's where splice() comes in. splice() allows us to do just that: remove any number of 
 ...
 * that splice() is being called upon. 
 * 
 ...
 * 
 * We've defined a function, sumOfTen, which takes an array as an argument and returns the sum of that 
 * array's elements. Modify the function, using splice(), so that it returns a value of 10.
 */
