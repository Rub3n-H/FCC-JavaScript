/**
 * Sometimes when working with arrays, it is very handy to be able to iterate through each item to find 
 * one or more elements that we might need, or to manipulate an array based on which data items meet a 
 ...
 * to achieve different results (such as every(), forEach(), map(), etc.), 
 * however the technique which is most flexible and offers us the greatest amount of control is a simple 
 * for loop.
 * 
